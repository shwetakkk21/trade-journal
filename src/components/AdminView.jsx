...
export function AdminView() {
  ...
  if (loading) return <div className="p-6 text-slate-400 animate-pulse text-xs font-mono">LOADING SECURITY LEDGER...</div>;

  return (
    <div className="space-y-6 max-w-5xl mx-auto font-sans">
      <div className="flex items-center gap-3 border-b border-slate-800 pb-4">
        <ShieldAlert className="w-5 h-5 text-teal-400" />
        <h1 className="text-xl font-bold text-slate-100 tracking-wide">Admin Control Panel</h1>
      </div>
